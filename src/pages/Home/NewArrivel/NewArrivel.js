...
const NewArrivel = () => {
  return (
    <section className='mb-20'>
      <h2 className='text-center text-3xl font-bold'>new arrival parts</h2>
      <div className='h-1 w-20 rounded-md bg-slate-800 mx-auto mt-4'></div>
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div>
      <h1 className="text-3xl font-bold">Bike Engine</h1>
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div>
      <h1 className="text-3xl font-bold">gear16-16T</h1>
  ...
  <div className="hero-content flex-col lg:flex-row">
    ...
    <div>
      <h1 className="text-3xl font-bold">face Helmet</h1>
